...
.prompt-card{overflow:hidden;display:flex;flex-direction:column}.prompt-text{overflow-wrap:anywhere}.prompt-note{margin-top:auto}.prompt-copy-label{position:relative;z-index:1;margin:0 0 6px;color:rgba(255,255,255,.42);font-size:10px;font-weight:900;letter-spacing:1.2px;text-transform:uppercase}
...
.template-market .prompt-grid{grid-template-columns:repeat(3,minmax(0,1fr));gap:20px;margin-bottom:20px}.template-market .prompt-card{background:#1a2744;color:#fff;padding:24px;position:relative;overflow:hidden;min-height:360px;border:0}.template-market .prompt-card::before{content:"";position:absolute;right:-40px;bottom:-40px;width:120px;height:120px;border-radius:50%;background:rgba(255,255,255,.04)}.template-market .prompt-number{font-size:11px;letter-spacing:2px;color:rgba(255,255,255,.35);text-transform:uppercase;margin-bottom:10px}.template-market .prompt-scene{font-size:14px;font-weight:900;color:#7ab8e8;margin-bottom:12px}.template-market .prompt-text{font-size:11px;color:rgba(255,255,255,.78);line-height:1.65;font-family:"Courier New",monospace;background:rgba(0,0,0,.2);padding:12px;border-left:2px solid rgba(122,184,232,.4);position:relative;z-index:1;max-height:188px;overflow:auto}.template-market .prompt-note{font-size:11px;color:rgba(255,255,255,.55);margin-top:12px;font-style:italic;position:relative;z-index:1;line-height:1.55}
...
.image-frame{display:inline-grid;grid-template-areas:"media";align-items:center;justify-items:center;max-width:100%}.image-frame>img,.image-frame>.image-load-fallback{grid-area:media}.image-load-fallback{display:inline-flex;align-items:center;justify-content:center;min-width:72px;min-height:72px;padding:8px;border:1px solid #d9dee8;background:linear-gradient(135deg,#f8fafc 0,#f8fafc 48%,#e6edf4 49%,#e6edf4 51%,#f8fafc 52%);color:#6f8198;font-size:12px;line-height:1.35;text-align:center}.image-frame-missing .image-load-fallback{background:linear-gradient(135deg,#f8fafc 0,#f8fafc 48%,#e6edf4 49%,#e6edf4 51%,#f8fafc 52%)}.image-load-fallback[hidden]{display:none!important}.image-load-fallback.is-visible{display:inline-flex}.comp-product-cell{display:grid;grid-template-columns:64px minmax(0,1fr);gap:12px;align-items:start;min-width:0}.comp-product-thumb{width:64px;height:64px;object-fit:contain;background:#f8fafc;border:1px solid rgba(26,39,68,.1);display:block}.comp-product-thumb-empty{width:64px;height:64px;background:linear-gradient(135deg,#f8fafc 0,#f8fafc 48%,#e6edf4 49%,#e6edf4 51%,#f8fafc 52%);border:1px solid rgba(26,39,68,.1);display:block}.comp-product-thumb-diagnostic{width:64px;height:64px;display:grid;place-items:center;text-align:center;background:#fbfaf8;border:1px dashed rgba(201,160,90,.55);color:#667085;font-size:10px;line-height:1.25;font-weight:800;padding:4px}.comp-product-thumb-diagnostic span,.comp-deep-image-diagnostic span{display:block;color:#1a2744;font-weight:900}.comp-product-thumb-diagnostic em,.comp-deep-image-diagnostic em{display:block;margin-top:2px;color:#8a9aaa;font-style:normal;font-size:10px;font-weight:700;line-height:1.3}.comp-image-strip-card,.comp-image-diagnostic-card{margin:16px 0 0}.comp-image-diagnostic-card{border-left:4px solid #c9a05a;background:#fbfaf8}.comp-image-diagnostic-card p{margin:8px 0 0;color:#5a6a7a;font-size:13px;line-height:1.6}.comp-image-diagnostic-card strong{color:#1a2744}.comp-image-strip{display:grid;grid-template-columns:repeat(8,minmax(0,1fr));gap:10px}.comp-image-item{margin:0;min-width:0}.comp-image-thumb{width:100%;aspect-ratio:1/1;object-fit:contain;background:#f8fafc;border:1px solid rgba(26,39,68,.1);display:block}.comp-image-item figcaption{margin-top:6px;color:#5a6a7a;font-size:11px;line-height:1.35;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden}.comp-deep-image{width:100%;height:168px;object-fit:contain;background:#f8fafc;border-bottom:1px solid rgba(26,39,68,.1);display:block}.comp-deep-image-empty{height:168px;background:linear-gradient(135deg,#f8fafc 0,#f8fafc 49%,#e6edf4 49.5%,#e6edf4 50.5%,#f8fafc 51%);border-bottom:1px solid rgba(26,39,68,.1)}.comp-deep-image-diagnostic{height:168px;display:grid;place-items:center;text-align:center;background:#fbfaf8;border-bottom:1px dashed rgba(201,160,90,.55);color:#667085;font-size:12px;line-height:1.45;padding:16px}
...
.cosmo-tag-module{display:grid;gap:16px}.cosmo-summary-strip{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:14px}.cosmo-summary-item{position:relative;border:1px solid #e0ddd8;background:#fff;padding:18px 18px 18px 20px;min-height:118px;overflow:hidden}.cosmo-summary-item:before{content:"";position:absolute;left:0;top:0;bottom:0;width:4px;background:#3d6b9e}.cosmo-summary-item.product:before{background:#3d6b9e}.cosmo-summary-item.user:before,.cosmo-summary-item.strong:before{background:#6a9a7a}.cosmo-summary-item.weak:before{background:#c4705a}.cosmo-summary-item span{display:block;color:#667085;font-size:11px;font-weight:900;letter-spacing:.8px;text-transform:uppercase}.cosmo-summary-item b{display:block;margin:8px 0 6px;color:#1a2744;font-size:30px;line-height:1;font-weight:900}.cosmo-summary-item em{display:block;color:#5a6a7a;font-size:12px;font-style:normal;line-height:1.45}.cosmo-layout{display:grid;grid-template-columns:1fr;gap:18px;align-items:start}.cosmo-layout-stacked{grid-template-columns:1fr}.cosmo-panel{border:1px solid #d9d5cf;background:#fff;padding:18px}.cosmo-panel-title{display:flex;align-items:center;gap:8px;margin:-2px 0 14px;padding-bottom:12px;border-bottom:1px solid #e0ddd8;color:#1a2744;font-size:15px;font-weight:900}.cosmo-panel-title:before{content:"";display:block;width:8px;height:18px;background:#1a2744}.cosmo-matrix{grid-row:auto}.cosmo-matrix-lanes{display:grid;gap:14px}.cosmo-matrix-lane{border:0;background:#fff;padding:12px 12px 14px;box-shadow:0 10px 24px rgba(26,39,68,.035)}.cosmo-matrix-lane.product-lane{border-left:3px solid #3d6b9e}.cosmo-matrix-lane.user-lane{border-left:3px solid #6a9a7a}.cosmo-lane-title{display:flex;align-items:baseline;gap:10px;flex-wrap:wrap;margin:0 0 10px;padding-bottom:10px;border-bottom:1px solid #e8e6e1;color:#1a2744}.cosmo-lane-title span{font-size:14px;font-weight:900}.cosmo-lane-title b{margin-left:auto;display:inline-grid;place-items:center;min-width:42px;height:24px;background:#1a2744;color:#fff;font-size:11px}.cosmo-lane-title em{flex:1 1 100%;color:#667085;font-size:11px;font-style:normal;line-height:1.35}.cosmo-lane-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:12px}.cosmo-submodule-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:18px}.cosmo-submodule{min-height:100%}.cosmo-matrix-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:10px}.cosmo-matrix-cell{border:0;background:#fbfcfd;padding:14px;min-height:248px;display:grid;grid-template-rows:auto;align-content:start;gap:9px;overflow:visible;box-shadow:0 10px 24px rgba(26,39,68,.055)}.cosmo-matrix-cell[data-dimension="产品标签"]{border-left:3px solid #3d6b9e}.cosmo-matrix-cell[data-dimension="用户标签"]{border-left:3px solid #6a9a7a}.cosmo-matrix-cell[data-confidence="高"]{border-top:3px solid #6a9a7a}.cosmo-matrix-cell[data-confidence="中"]{border-top:3px solid #c9a05a}.cosmo-matrix-cell[data-confidence="低"]{border-top:3px solid #c4705a;background:#fffaf8}.cosmo-matrix-cell[data-confidence="高"] .cosmo-confidence-pill{background:#eaf5ee;color:#2f7d55;border-color:rgba(47,125,85,.25)}.cosmo-matrix-cell[data-confidence="中"] .cosmo-confidence-pill{background:#fff7e8;color:#9a6a17;border-color:rgba(201,160,90,.32)}.cosmo-matrix-cell[data-confidence="低"] .cosmo-confidence-pill{background:#fff1ed;color:#b42318;border-color:rgba(196,112,90,.32)}.cosmo-card-top{display:flex;justify-content:space-between;gap:8px;align-items:flex-start;margin:0}.cosmo-relation-lane{display:inline-flex;align-items:center;gap:6px;margin-bottom:5px}.cosmo-relation-kind{font-size:10.5px;font-weight:900;color:#3d6b9e;letter-spacing:.4px}.cosmo-relation-id{display:inline-grid;place-items:center;min-width:30px;height:20px;background:#1a2744;color:#fff;font-size:10px;line-height:1}.cosmo-matrix-cell[data-dimension="用户标签"] .cosmo-relation-id{background:#2f7d55}.cosmo-relation-title{margin:4px 0 0;font-size:15px;line-height:1.25;color:#1a2744}.cosmo-confidence-pill{flex:0 0 auto;border:1px solid rgba(26,39,68,.14);padding:2px 6px;font-size:10.5px;font-weight:900;white-space:nowrap}.cosmo-relation-meta{margin:0!important;color:#667085;font-size:11px;line-height:1.35}.cosmo-card-meta-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px;margin:0;padding:8px 0;border-top:1px solid #eef1f4;border-bottom:1px solid #eef1f4}.cosmo-card-meta-grid div{border:0;background:transparent;padding:0;min-width:0}.cosmo-card-meta-grid dt{margin:0;color:#667085;font-size:10px;font-weight:900;line-height:1.2}.cosmo-card-meta-grid dd{margin:3px 0 0;color:#1a2744;font-size:11px;font-weight:900;line-height:1.25}.cosmo-term-block{border:0;background:#f7f9fc;padding:8px 10px;margin:0;min-width:0}.cosmo-block-label{margin:0 0 6px;color:#667085;font-size:10px;font-weight:900;line-height:1.2}.cosmo-tag-terms{display:flex;flex-wrap:wrap;gap:5px;margin:0}.cosmo-tag-terms span{padding:3px 6px;background:#eef4f8;color:#1a2744;border:0;font-size:10.5px;font-weight:800;line-height:1.25;max-width:100%;overflow:hidden;text-overflow:ellipsis}.cosmo-evidence-strip{display:flex;align-items:center;justify-content:space-between;gap:8px;margin:0;padding:6px 8px;background:#f7f6f2;border:0}.cosmo-evidence-strip span{font-size:11px;color:#667085;font-weight:900}.cosmo-evidence-strip b{color:#1a2744;font-size:14px}.cosmo-evidence-strip em{color:#667085;font-size:11px;font-style:normal;font-weight:900;line-height:1.25}.cosmo-evidence-sources{display:flex;align-items:center;gap:5px;flex-wrap:wrap;margin:0;padding:0;background:transparent;border:0}.cosmo-evidence-sources b{color:#667085;font-size:10px;font-weight:900;margin-right:2px}.cosmo-evidence-sources span{display:inline-flex;align-items:center;gap:4px;padding:2px 6px;background:#eef4f8;color:#1a2744;border:0;font-size:10px;font-weight:800;line-height:1.2}.cosmo-evidence-sources em{display:inline-grid;place-items:center;min-width:16px;height:16px;background:#1a2744;color:#fff;font-size:9px;font-style:normal;line-height:1}.cosmo-business-meaning{margin:0!important;padding-top:8px;border-top:1px solid #eef1f4;color:#5a6a7a!important;font-size:11.5px!important;line-height:1.45!important}.cosmo-business-meaning b{color:#1a2744}.cosmo-action-direction{border-top:1px solid #eef1f4;padding-top:8px;display:grid;gap:4px}.cosmo-action-direction span{color:#667085;font-size:10px;font-weight:900;line-height:1.2}.cosmo-action-direction b{color:#1a2744;font-size:11px;line-height:1.35}.cosmo-top-list ol,.cosmo-gap-panel ul{list-style:none;margin:0;padding:0;display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:10px}.cosmo-top-list li,.cosmo-gap-panel li{display:grid;grid-template-columns:1fr;gap:5px;padding:12px;background:#fbfcfd;border:0;border-left:3px solid #3d6b9e;box-shadow:0 6px 16px rgba(26,39,68,.045)}.cosmo-gap-panel li{border-left-color:#c9a05a}.cosmo-top-list li:last-child,.cosmo-gap-panel li:last-child{border-bottom:0}.cosmo-top-list li span,.cosmo-gap-panel li span{color:#3d6b9e;font-size:11px;font-weight:900}.cosmo-top-list li strong,.cosmo-gap-panel li strong{color:#1a2744;font-size:13px;line-height:1.35}.cosmo-top-list li em,.cosmo-gap-panel li em{grid-column:auto;color:#667085;font-size:11px;font-style:normal}.cosmo-gap-panel p{margin:0 0 12px;color:#5a6a7a;font-size:13px;line-height:1.65}.cosmo-action-board{grid-column:1/-1}.cosmo-action-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:12px}.cosmo-action-card{border:0;background:#fbfcfd;padding:14px;min-height:190px;border-top:3px solid #3d6b9e;box-shadow:0 6px 16px rgba(26,39,68,.045)}.cosmo-action-card[data-action-kind="用户标签"]{border-top-color:#6a9a7a}.cosmo-action-card span{font-size:11px;color:#3d6b9e;font-weight:900;letter-spacing:.4px}.cosmo-action-card h3{margin:6px 0 10px;color:#1a2744;font-size:14px}.cosmo-action-list{list-style:none;margin:0;padding:0;display:grid;gap:8px}.cosmo-action-list li{display:grid;grid-template-columns:72px minmax(0,1fr);gap:8px;border-top:1px solid #eef1f4;padding-top:8px}.cosmo-action-list li:first-child{border-top:0;padding-top:0}.cosmo-action-list b,.cosmo-action-label{font-size:11px;color:#1a2744}.cosmo-action-list span{font-size:12px!important;color:#5a6a7a!important;font-weight:500!important;letter-spacing:0!important;line-height:1.5}
body.diagnostic-page .site-nav{position:sticky;top:0;right:auto;left:auto;z-index:50;justify-content:center;width:100%;max-width:100%;background:#1a2744;border-bottom:1px solid rgba(255,255,255,.12);padding:10px 24px;box-shadow:0 8px 24px rgba(26,39,68,.16)}
body.diagnostic-page .site-nav a{color:#fff}.diagnostic-page .site-nav-brand{display:inline-flex}.diagnostic-page .site-nav-links a{border-color:rgba(255,255,255,.18);background:rgba(255,255,255,.06)}.diagnostic-page .container{padding-top:28px}.diagnostic-section:first-of-type{margin-top:0}
body.template-demand.diagnostic-page{background:#f4f2ef;color:#1a2744}body.template-demand.diagnostic-page .section,body.template-demand.diagnostic-page .sec{background:rgba(255,255,255,.9);border-color:rgba(26,39,68,.12);box-shadow:0 10px 30px rgba(26,39,68,.06);color:#1a2744}body.template-demand.diagnostic-page .section-title,body.template-demand.diagnostic-page .section-desc,body.template-demand.diagnostic-page .kpi-label,body.template-demand.diagnostic-page .card-title,body.template-demand.diagnostic-page .chart-title{color:#1a2744}body.template-demand.diagnostic-page .section-desc,body.template-demand.diagnostic-page .muted{color:#667085}body.template-demand.diagnostic-page .evidence-table th,body.template-demand.diagnostic-page .insight-table th{background:#1a2744;color:#fff}body.template-demand.diagnostic-page .evidence-table td,body.template-demand.diagnostic-page .insight-table td{background:#fff;color:#1a2744}
.diagnostic-page .table-tools{margin:12px 0 6px}.diagnostic-page .table-tools input{height:34px;border-color:rgba(26,39,68,.18);background:#fff;color:#1a2744}
.diagnostic-filter-bar{margin:18px 0 12px}.diagnostic-filter-bar .filter-btn{border:1px solid rgba(26,39,68,.14);background:#fff;color:#1a2744;padding:8px 14px;font-size:12px;letter-spacing:.4px}.diagnostic-filter-bar .filter-btn.active,.diagnostic-filter-bar .filter-btn[aria-pressed=true]{background:#1a2744;color:#fff;border-color:#1a2744}
.diagnostic-tabs{display:flex;align-items:center;gap:8px;flex-wrap:wrap;margin:10px 0 18px}.diagnostic-tabs .tab-button{border:1px solid rgba(26,39,68,.14);background:#fff;color:#1a2744;padding:8px 14px;font-size:12px}.diagnostic-tabs .tab-button[aria-selected=true]{background:#1a2744;color:#fff}.diagnostic-tabs [data-tab-panel]{flex:1 1 100%;border:1px solid rgba(26,39,68,.1);background:#fbfaf8;padding:10px 12px;color:#5a6a7a;font-size:13px}
.diagnostic-page .diagnostic-chart{min-height:0;padding:16px;background:#fbfaf8;border:1px solid rgba(26,39,68,.12)}.diagnostic-page .diagnostic-chart .mini-chart{border:0;background:transparent;padding:0}.diagnostic-page .diagnostic-chart .bar-row{grid-template-columns:120px minmax(0,1fr) 72px;min-height:42px;padding:6px 0}.diagnostic-page .diagnostic-chart .bar-row>span:first-child{font-size:13px}.diagnostic-page .diagnostic-chart .bar{height:7px}.diagnostic-chart-container{background:#fbfaf8}.diagnostic-chart-body{height:auto!important;min-height:190px;display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:12px;align-content:start}.diagnostic-chart-item{border:1px solid rgba(26,39,68,.12);background:#fff;padding:14px;min-width:0}.diagnostic-chart-item span{display:block;color:#667085;font-size:11px;font-weight:900}.diagnostic-chart-item b{display:block;margin:8px 0 6px;color:#1a2744;font-size:22px;line-height:1}.diagnostic-chart-item em{display:block;color:#5a6a7a;font-size:12px;font-style:normal;line-height:1.5}.diagnostic-slot-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:14px;margin:18px 0 20px}.diagnostic-slot-card{border:1px solid rgba(26,39,68,.14);border-top:4px solid #c9a05a;background:#fff;padding:16px;min-height:176px;color:#1a2744;display:flex;flex-direction:column;gap:10px}.diagnostic-slot-card.blocked{border-top-color:#c4705a}.diagnostic-slot-card.watch{border-top-color:#c9a05a}.diagnostic-slot-head{display:flex;align-items:center;gap:10px}.diagnostic-slot-head span{display:inline-grid;place-items:center;width:28px;height:28px;background:#1a2744;color:#fff;font-size:12px;font-weight:900}.diagnostic-slot-head strong{font-size:15px;line-height:1.35}.diagnostic-slot-status{width:max-content;padding:4px 8px;background:#fdebe6;color:#a24732;font-size:12px;font-weight:900}.diagnostic-slot-metric{font-size:22px;line-height:1;font-weight:900;color:#1a2744}.diagnostic-slot-card p{margin:0;color:#5a6a7a;font-size:12px;line-height:1.65}.diagnostic-slot-bar{height:6px;background:#ece7df;margin-top:auto;overflow:hidden}.diagnostic-slot-bar span{display:block;height:100%;width:var(--w,45%);background:#6a9a7a}
...
(function(){
  ...
  function showImageFallback(img){
    ...
    img.hidden=true;
    if(img.parentElement&&img.parentElement.classList)img.parentElement.classList.add('image-frame-missing');
  ...
  function tableRows(id){
    ...
    return [...table.querySelectorAll('tbody tr')].map((row,idx)=>{
      ...
      const label=(row.dataset.skuLabel||cells[3]||cells[1]||cells[0]||('拓品方案 '+(idx+1)))
        .replace(/图片未返回|竞品图片未返回|参考竞品图片未返回|采集层未返回[^；。]*/g,'')
        .replace(/\\s+/g,' ')
        .trim()||('拓品方案 '+(idx+1));
  ...
  function lifecycleCharts(){
    ...
    skuRows.forEach(row=>{
      const path=shortLabel(row.ecosystemPath||'拓品路径',8);
      const segment=shortLabel(row.segment||'赛道归类',10);
    ...
    const sunburstData=[...pathMap.entries()].map(([path,segmentMap],pathIdx)=>{
      ...
      return {
        name:shortLabel(path,8),
        value:pathRows.length,
        itemStyle:{color:pathColors[pathIdx%pathColors.length]},
        children:[...segmentMap.entries()].map(([segment,rows])=>({
          name:shortLabel(segment,10),
          value:rows.length,
          children:rows.slice(0,5).map(row=>({name:shortLabel(row.shortSku||row.label,8),value:1,itemStyle:{color:typeColors[row.type]||pathColors[pathIdx%pathColors.length]}}))
        }))
      };
    });
    chart('sunburst',{tooltip:{trigger:'item',formatter:p=>`${p.name}<br/>SKU：${p.value}`},nodeClick:false,series:[{name:shortLabel(rootName,16),type:'sunburst',data:sunburstData,radius:[0,'82%'],sort:null,label:{show:false},emphasis:{focus:'ancestor'},levels:[{}, {r0:'0%',r:'24%',label:{show:true,rotate:0,fontSize:12,color:'#fff',overflow:'truncate'},itemStyle:{borderWidth:3,borderColor:'#fff'}}, {r0:'24%',r:'56%',label:{show:true,rotate:0,fontSize:10,color:primaryColor,width:72,overflow:'truncate'},itemStyle:{borderWidth:2,borderColor:'#fff'}}, {r0:'56%',r:'82%',label:{show:false},itemStyle:{borderWidth:1,borderColor:'#fff'}}]}]});
    ...
    if(priorityEl&&skuRows.length<=8){
      priorityEl.classList.add('priority-compact-grid');
      priorityEl.innerHTML=sortedAll.slice(0,8).map((row,idx)=>`<article class="priority-score-card"><div><strong>${escapeHtml(row.shortSku||row.label||('拓品方案 '+(idx+1)))}</strong><span>${escapeHtml(row.ecosystemPath||'-')} · ${escapeHtml(row.segment||'-')}</span></div><b>${Math.min(100,Math.max(1,row.value))}</b></article>`).join('');
    }else{
      if(priorityEl)priorityEl.classList.remove('priority-compact-grid');
      const chartTitle=skuRows.length>20?'Top 15 SKU 优先级':'SKU 优先级列表';
      chart('priorityChart',{title:{text:chartTitle,left:8,top:0,textStyle:{fontSize:12,color:'#5a6a7a',fontWeight:700}},tooltip:{trigger:'axis',axisPointer:{type:'shadow'},formatter:items=>{const item=Array.isArray(items)?items[0]:items;const row=sorted[item.dataIndex]||{};return `${row.shortSku||row.label}<br/>优先级：${item.value}<br/>路径：${row.ecosystemPath||'-'}<br/>赛道：${row.segment||'-'}`;}},grid:{left:150,right:46,bottom:26,top:34,containLabel:true},xAxis:{type:'value',max:100,axisLabel:{fontSize:10,color:'#8a9aaa'},splitLine:{lineStyle:{color:'#f0ede8'}}},yAxis:{type:'category',data:sorted.map(row=>shortLabel(row.shortSku||row.label,12)),axisLabel:{fontSize:11,color:'#5a6a7a',width:132,overflow:'truncate'}},series:[{type:'bar',data:sorted.map(row=>({value:Math.min(100,Math.max(1,row.value)),itemStyle:{color:typeColors[row.type]||accentColor}})),barMaxWidth:16,label:{show:true,position:'insideRight',fontSize:10,color:'#fff',formatter:'{c}'}}]});
    }
...
body.template-market #cosmo-alexa-tags .kpi-card{padding:18px;min-width:0}
body.template-market #cosmo-alexa-tags .cosmo-summary-strip{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:14px}
body.template-market #cosmo-alexa-tags .cosmo-summary-item{position:relative;border:1px solid #e0ddd8;background:#fff;padding:18px 18px 18px 22px;min-height:118px;overflow:hidden}
body.template-market #cosmo-alexa-tags .cosmo-summary-item:before{content:"";position:absolute;left:0;top:0;bottom:0;width:4px;background:#3d6b9e}
body.template-market #cosmo-alexa-tags .cosmo-summary-item.product:before{background:#3d6b9e}
body.template-market #cosmo-alexa-tags .cosmo-summary-item.user:before,body.template-market #cosmo-alexa-tags .cosmo-summary-item.strong:before{background:#6a9a7a}
body.template-market #cosmo-alexa-tags .cosmo-summary-item.weak:before{background:#c4705a}
body.template-market #cosmo-alexa-tags .cosmo-summary-item span{display:block;color:#667085;font-size:11px;font-weight:900;letter-spacing:.8px;text-transform:uppercase}
body.template-market #cosmo-alexa-tags .cosmo-summary-item b{display:block;margin:8px 0 6px;color:#1a2744;font-size:30px;line-height:1;font-weight:900}
body.template-market #cosmo-alexa-tags .cosmo-summary-item em{display:block;color:#5a6a7a;font-size:12px;font-style:normal;line-height:1.45}
body.template-market #cosmo-alexa-tags .cosmo-panel{border:1px solid #d9d5cf;background:#fff;padding:18px}
body.template-market #cosmo-alexa-tags .cosmo-matrix-lane{border:0;background:#fff;padding:14px 14px 16px;box-shadow:0 10px 24px rgba(26,39,68,.035)}
body.template-market #cosmo-alexa-tags .cosmo-lane-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:12px}
body.template-market #cosmo-alexa-tags .cosmo-matrix-cell{border:0;background:#fbfcfd;padding:14px;min-height:248px;display:grid;grid-template-rows:auto;align-content:start;gap:9px;overflow:visible;box-shadow:0 10px 24px rgba(26,39,68,.055)}
body.template-market #cosmo-alexa-tags .cosmo-matrix-cell[data-dimension="产品标签"]{border-left:3px solid #3d6b9e}
body.template-market #cosmo-alexa-tags .cosmo-matrix-cell[data-dimension="用户标签"]{border-left:3px solid #6a9a7a}
body.template-market #cosmo-alexa-tags .cosmo-matrix-cell[data-confidence="高"]{border-top:3px solid #6a9a7a}
body.template-market #cosmo-alexa-tags .cosmo-matrix-cell[data-confidence="中"]{border-top:3px solid #c9a05a}
body.template-market #cosmo-alexa-tags .cosmo-matrix-cell[data-confidence="低"]{border-top:3px solid #c4705a;background:#fffaf8}
body.template-market #cosmo-alexa-tags .cosmo-card-meta-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px;margin:0;padding:8px 0;border-top:1px solid #eef1f4;border-bottom:1px solid #eef1f4}
body.template-market #cosmo-alexa-tags .cosmo-card-meta-grid div{border:0;background:transparent;padding:0;min-width:0}
body.template-market #cosmo-alexa-tags .cosmo-term-block{border:0;background:#f7f9fc;padding:8px 10px;margin:0;min-width:0}
body.template-market #cosmo-alexa-tags .cosmo-evidence-strip{display:flex;align-items:center;justify-content:space-between;gap:8px;margin:0;padding:6px 8px;background:#f7f6f2;border:0}
body.template-market #cosmo-alexa-tags .cosmo-evidence-sources{display:flex;align-items:center;gap:5px;flex-wrap:wrap;margin:0;padding:0;background:transparent;border:0}
body.template-market #cosmo-alexa-tags .cosmo-business-meaning{margin:0!important;padding-top:8px;border-top:1px solid #eef1f4;color:#5a6a7a!important;font-size:11.5px!important;line-height:1.45!important}
body.template-market #cosmo-alexa-tags .cosmo-action-direction{border-top:1px solid #eef1f4;padding-top:8px;display:grid;gap:4px}
body.template-market #cosmo-alexa-tags .cosmo-submodule-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:18px}
body.template-market #cosmo-alexa-tags .cosmo-top-list ol,body.template-market #cosmo-alexa-tags .cosmo-gap-panel ul{list-style:none;margin:0;padding:0;display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:10px}
body.template-market #cosmo-alexa-tags .cosmo-top-list li,body.template-market #cosmo-alexa-tags .cosmo-gap-panel li{display:grid;grid-template-columns:1fr;gap:5px;padding:12px;background:#fbfcfd;border:0;border-left:3px solid #3d6b9e;box-shadow:0 6px 16px rgba(26,39,68,.045)}
body.template-market #cosmo-alexa-tags .cosmo-gap-panel li{border-left-color:#c9a05a}
body.diagnostic-page .section,body.diagnostic-page .sec{overflow:visible}body.diagnostic-page .table-tools{display:flex;align-items:center;justify-content:flex-end;gap:10px;margin:12px 0 10px}body.diagnostic-page .table-tools input{width:min(320px,100%);height:36px;padding:0 12px!important;border:1px solid rgba(26,39,68,.18)!important;background:#fff!important;color:#1a2744!important;font-size:13px!important;line-height:36px!important}body.diagnostic-page .evidence-table,body.diagnostic-page .insight-table,body.diagnostic-page .supply-diagnostic-table{width:100%!important;max-width:100%!important;border-collapse:collapse!important;table-layout:auto!important;border:1px solid #e0ddd8!important;background:#fff!important;overflow:visible!important}body.diagnostic-page .evidence-table th,body.diagnostic-page .evidence-table td,body.diagnostic-page .insight-table th,body.diagnostic-page .insight-table td,body.diagnostic-page .supply-diagnostic-table th,body.diagnostic-page .supply-diagnostic-table td{padding:12px 14px!important;border-bottom:1px solid rgba(26,39,68,.1)!important;vertical-align:top!important;color:#1a2744!important;font-size:13px!important;line-height:1.55!important;white-space:normal!important;text-align:left}body.diagnostic-page .evidence-table th,body.diagnostic-page .insight-table th,body.diagnostic-page .supply-diagnostic-table th{background:#1a2744!important;color:#fff!important;font-weight:900!important}body.diagnostic-page .evidence-table td:first-child,body.diagnostic-page .evidence-table th:first-child,body.diagnostic-page .insight-table td:first-child,body.diagnostic-page .insight-table th:first-child,body.diagnostic-page .supply-diagnostic-table td:first-child,body.diagnostic-page .supply-diagnostic-table th:first-child{padding-left:16px!important}.diagnostic-filter-bar{display:flex;align-items:center;gap:8px;flex-wrap:wrap;margin:16px 0 12px!important;padding:0!important}.diagnostic-filter-bar .filter-btn{display:inline-flex;align-items:center;justify-content:center;min-height:34px;border:1px solid rgba(26,39,68,.16)!important;background:#fff!important;color:#1a2744!important;padding:8px 14px!important;font-size:12px!important;font-weight:900!important;line-height:1!important;letter-spacing:0!important}.diagnostic-filter-bar .filter-btn.active,.diagnostic-filter-bar .filter-btn[aria-pressed=true]{background:#1a2744!important;color:#fff!important;border-color:#1a2744!important}.diagnostic-tabs{display:grid!important;grid-template-columns:repeat(2,max-content) minmax(0,1fr);gap:8px;align-items:start;margin:12px 0 18px!important}.diagnostic-tabs .tab-button{display:inline-flex;align-items:center;justify-content:center;min-height:34px;border:1px solid rgba(26,39,68,.16)!important;background:#fff!important;color:#1a2744!important;padding:8px 14px!important;font-size:12px!important;font-weight:900!important;line-height:1!important}.diagnostic-tabs .tab-button[aria-selected=true]{background:#1a2744!important;color:#fff!important;border-color:#1a2744!important}.diagnostic-tabs [data-tab-panel]{grid-column:1/-1!important;border:1px solid rgba(26,39,68,.1)!important;background:#fbfaf8!important;padding:12px 14px!important;color:#5a6a7a!important;font-size:13px!important;line-height:1.6!important}.diagnostic-tabs [data-tab-panel][hidden]{display:none!important}.diagnostic-page .diagnostic-chart{border:1px solid rgba(26,39,68,.12)!important;background:#fbfaf8!important;padding:16px!important}.diagnostic-page .diagnostic-chart .mini-chart{border:0!important;background:transparent!important;padding:0!important}.diagnostic-slot-section{margin-top:26px}.diagnostic-slot-detail{display:grid;gap:16px}.diagnostic-component-skeleton{margin:0}.comp-image-placeholder{min-height:118px;border:1px dashed rgba(61,107,158,.35);background:#f8fafc;color:#5a6a7a;display:grid;place-items:center;text-align:center;font-size:12px;font-weight:900;padding:14px}.tiktok-diagnostic-card{border-left:4px solid #3d6b9e;background:#fff}.tiktok-diagnostic-card .kpi-grid{margin:10px 0 14px}.template-market .prompt-copy{font-size:12px;color:rgba(255,255,255,.82);line-height:1.7;font-family:"Courier New",monospace;background:rgba(0,0,0,.22);padding:14px;border-left:2px solid rgba(122,184,232,.45);position:relative;z-index:1;max-height:190px;overflow:auto}.comp-deep-body{padding:16px}.comp-deep-body h3{margin:0 0 8px;color:#1a2744;font-size:16px;line-height:1.35}.comp-deep-body p{margin:8px 0 0;color:#5a6a7a;font-size:12px;line-height:1.65}.deep-dive-grid .benchmark-card{overflow:hidden}.diagnostic-page .comp-image-strip-card,.diagnostic-page .comp-image-diagnostic-card{margin:0}.diagnostic-page .comp-image-strip{grid-template-columns:repeat(8,minmax(0,1fr))}.diagnostic-page .deep-dive-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:16px;margin-top:16px}
""".strip()
